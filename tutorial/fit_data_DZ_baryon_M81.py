...
data = np.genfromtxt("dataM81.txt", names=True)

Ms0=6.38e10+1.36*2*2.54e9 
MBH=7e7
rH = 3.92
...
bounds = ([1.,0.5,0.,2], [120, 120, 1.1,18])
p0_adjusted = [
...
fs=18
ax = fig.gca()
ax.text(0.05,0.62,"M81+baryon+BH", transform=ax.transAxes, fontsize=20, verticalalignment='top')
ax.text(0.5,0.96,r"Cored-DZ fit", transform=ax.transAxes, fontsize=20, verticalalignment='top')
delta=0.07
...
plt.show()
fig.savefig('fig_fitted_Vcirc_M81.pdf', bbox_inches='tight')
