...
bounds = ([1.,0.5,0.,0.2], [120, 120, 1.1,18])
p0_adjusted = [
...
fs=18
ax = fig.gca()
ax.text(0.05,0.62,"IC2574 DM-only", transform=ax.transAxes, fontsize=20, verticalalignment='top')
...
plt.show()
fig.savefig('fig_fitted_Vcirc_IC2574_DMO.pdf', bbox_inches='tight')
